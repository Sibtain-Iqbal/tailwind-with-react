...
function Compo({details ,Designers}) {
    console.log(details);
  return (
    <div>
                ...
                <td class="whitespace-nowrap px-4 py-4">
                  <div class="flex items-center">
                    ...
                    <div class="ml-4">
                      ...
                      <div class="text-sm text-gray-700">{details.EmployEmail}</div>
                    </div>
                  </div>
                </td>
                <td class="whitespace-nowrap px-12 py-4">
                  <div class="text-sm text-gray-900 ">{details.Title}</div>
              ...
              <tr>
                <td class="whitespace-nowrap px-4 py-4">
                  <div class="flex items-center">
                    ...
                    <div class="ml-4">
                      <div class="text-sm font-medium text-gray-900">
                        {Designers.EmployName}
                      </div>
                      <div class="text-sm text-gray-700">{Designers.EmployEmail}</div>
                    </div>
                  </div>
                </td>
                <td class="whitespace-nowrap px-12 py-4">
                  <div class="text-sm text-gray-900 ">{Designers.Title}</div>
                  <div class="text-sm text-gray-700">UIUX</div>
                </td>
                <td class="whitespace-nowrap px-4 py-4">
                  <span class="inline-flex rounded-full bg-green-100 px-2 text-xs font-semibold leading-5 text-green-800">
                    {Designers.Active}
